...
# 회고
 ...
 - 메모리 초과... 왤까?
   이 문제는 최악의 경우 1,000,000개의 토마토가 들어온다. 그러면 2차원 배열까지는 괜찮지만, 그 좌표를 큐에 담은 vector<pair<int,int>>는 엄청 커진다. 
   게다가 이전 제출에서 나는 모든 시작지점에 대해서 Queue를 생성했으니까.. 메모리를 꽤 잡아먹었을거다.
