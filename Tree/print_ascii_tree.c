...
struct asciinode_struct {
  ...
  //-1=I am left, 0=I am root, 1=right. 부모에 대한 자기자신의 상대적 위치
  int parent_dir;
 ...
 * 기존에 있는 이진트리를 출력 용이하도록 asciinode 트리로 변환
 * 주요 데이터는 parent_dir, lablen. */
