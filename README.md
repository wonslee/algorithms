...
## 커리큘럼
1. 코테 빈출 & 기본 : 백준 단계별로 풀어보기(바킹독 커리큘럼대로 100개)
- **브루트 포스**
- **백트래킹(DFS)**
- **그래프 순회(BFS)** : 16
- **DP** 1 : 16
...
2. 바쁜 날 :  **복습**
   그냥 한번씩 **다시 강의** 다 보자 (자료구조,DFS,BFS,DP,그리디,brute force, 이분탐색). 개념이 체득될때까지 계속.  
   **개념을 알겠어도 다시 풀어**. '문제 파악' 방식으로 공부하려면 일단 구현을 잘해야 함. 
   **이전에 풀었던 문제들**.  못 풀었다면 다시 바킹독 강의로 돌아가!!  

   풀었던 것들중에 **별표 친 놈들** 유형 보지 말고 다시(23개 정도)  
   
   문제 제출은 브론즈라도 괜찮으니 그냥 아무거나 풀어서 내자. 

3. 널널한 날 : 계속 풀기 (랜덤 140개. 브루트포스, DFS(백트래킹), BFS, DP, 그리디, 이분탐색, 시뮬레이션(구현))
